...
class Company < ApplicationRecord
  ...
  belongs_to :headquarters_geography, class_name: 'Geography', optional: true
  ...
  delegate :cp_alignment_2050, :cp_alignment_2025, :cp_alignment_2027, :cp_alignment_2028, :cp_alignment_2030, :cp_alignment_2035,
           :cp_regional_alignment_2050, :cp_regional_alignment_2025, :cp_regional_alignment_2027, :cp_regional_alignment_2028,
           :cp_regional_alignment_2030, :cp_regional_alignment_2035, to: :latest_cp_assessment, allow_nil: true
