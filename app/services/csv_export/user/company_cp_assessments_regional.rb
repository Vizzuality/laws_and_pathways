    ...
    class CompanyCPAssessmentsRegional
      ...
      def call
        ...
        headers = [
          ...
          'Carbon Performance Regional Alignment 2028',
          'Carbon Performance Regional Alignment 2030',
        ...
        CSV.generate("\xEF\xBB\xBF") do |csv|
          ...
          @assessments.each do |assessment|
            csv << [
              ...
              assessment.cp_regional_alignment_2028,
              assessment.cp_regional_alignment_2030,
