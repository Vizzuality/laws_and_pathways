module TPI
  class HomeController < TPIController
    ...
    def home_content
      ...
      {
        intro: {
          title: page&.contents&.first&.title || 'The TPI tool',
          description: ActionView::Base.full_sanitizer.sanitize(page&.contents&.first&.text) ||
        ...
        investors: {
          title: page&.contents&.second&.title || 'How investors can use the TPI',
          description: ActionView::Base.full_sanitizer.sanitize(page&.contents&.second&.text) ||
            'The TPI is designed to support investors. Find out how they can use its findings.'
        },
        supporters: {
          title: page&.contents&.third&.title || 'Supporters',
          description: ActionView::Base.full_sanitizer.sanitize(page&.contents&.third&.text) ||
