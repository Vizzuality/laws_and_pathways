...
describe 'CSVDataUpload (integration)' do
  ...
  it 'imports CSV files with Company CP Assessments data' do
    ...
    expect(assessment.cp_alignment_2028).to eq('Paris Pledges')
    ...
    expect(assessment.cp_regional_alignment_2028).to eq('1.5 Degrees')
  ...
  it 'import CSV file with ASCOR benchmarks data' do
    ...
    benchmark = ASCOR::Benchmark.joins(:country).find_by ascor_countries: {iso: 'JPN'}
